# mvp-infinite-field Specification

## Purpose
Defines the gameplay behavior for the `mvp_gamekit.py` sample's infinite field, where the player remains centered on screen while the world moves around them.
